...
" License:      Same as Vim
" Last Updated: Fri Jun  9 22:48:57 2023
...
let s:t_Co = has('gui_running') ? -1 : get(g:, 'industry_t_Co', get(g:, 't_Co', exists('&t_Co') ? +&t_Co : 0))
...
if has('nvim')
  ...
  let g:terminal_color_1 = '#870000'
  let g:terminal_color_2 = '#5fd75f'
